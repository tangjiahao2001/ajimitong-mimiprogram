...
! function() {
	...
	function s(e, t) {
		...
		var n = e.__route__,
			...
			r = function(e, o) {
				...
				a.paraInfo.userInfo = o, y.http(r, a)
			}
	}
	...
	function f(e, t) {
		...
		y.http(r, i);
		var u = n.indexOf("?") === -1 ? n : n.substring(0, n.indexOf("?")) + ("?hotapp_share_id=" + o);
		...
		return d("shareUrl: ", u), t.path = u, t
	}
			...
			e[t] = function(e) {
				...
				if ("onError" == t) {
					...
					if (v.isArray(i) && v.isObject(i[1])) {
						...
						var u = i[0],
							c = i[1],
							s = ["getStorageSync:fail"];
						if (l.inArray(c.msg, s)) return o.call(this, e);
						try {
							y.http(u, c, function(e, t) {
	...
	var l = function() {
			...
			function n(e) {
				return p.isObject(e) ? 0 === Object.getOwnPropertyNames(e)
					.length : p.isArray(e) ? 0 === e.length : !e
			}
